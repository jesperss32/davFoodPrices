...
def load_production_data():
    ...
    production_df = pd.read_csv('/home/student/Documents/Projecten/davFoodPrices/data/productiondata/cleaned_reduced_production.csv', encoding='latin-1')
...
def getLinkedProduct(product):
	...
	return prod.production_df_product.unique().tolist()

def getPriceLinkedProduct(product):
	linked_products = pd.read_csv('/home/student/Documents/Projecten/davFoodPrices/data/Linked_products.csv', encoding='UTF-8', delimiter=";")
	prod = linked_products.query('production_df_product == \"' + product + '\"')
	return prod.price_df_product.unique().tolist()
